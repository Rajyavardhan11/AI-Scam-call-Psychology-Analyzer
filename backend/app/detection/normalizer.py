"""
SurakshaCall AI — Text Normalizer
Owner: Lakshay
Task: L-03
...
NORMALIZATION_MAP = {
    ...
    r"\bhai\b": "hai",
    r"\bkaro\b": "karo",
    r"\bbol raha\b": "bol raha",
    r"\bturant\b": "immediately",
    r"\bkisi ko mat batana\b": "do not tell anyone",
    r"\bcall mat katna\b": "do not disconnect",
}
...
def normalize(raw_text: str, language: Optional[str] = None) -> NormalizedUtterance:
    ...
    for pattern_str, replacement in NORMALIZATION_MAP.items():
        normalized = re.sub(pattern_str, replacement, normalized, flags=re.I)
